  ...
  return (
    <>
      ...
      <div className={cn("md:hidden", className)}>
        {/* Mobile collapsed banner (only show in green state when collapsed) */}
            ...
            >
              <div className="flex items-center gap-3 min-w-0 flex-1">
                ...
                <div className="text-sm font-medium truncate flex items-center gap-2">
                  <span>{formatDateRange()} • {numberOfNights} {numberOfNights === 1 ? t('booking.night', 'night') : t('booking.nights', 'nights')}</span>
