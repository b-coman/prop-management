...
import { MarketPanel, type MarketRow, type MarketSummary, type PeriodGroupView } from './_components/market-panel';
...
export default async function PricingPage({
  ...
  let market: { ok: boolean; error?: string; rows?: unknown[]; grouped?: unknown[]; summary?: unknown } = { ok: false, error: 'not loaded' };
        ...
        <Tabs defaultValue="year">
          ...
          */}
          <TabsContent value="market" className="space-y-6">
            {market.ok ? (
              <MarketPanel rows={market.rows as MarketRow[]} grouped={market.grouped as PeriodGroupView[]} summary={market.summary as MarketSummary} />
            ) : (
              <Card>
                <CardHeader>
