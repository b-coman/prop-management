...
const firebaseConfig = {
  apiKey: process.env.NEXT_PUBLIC_FIREBASE_API_KEY, // Correct Name
  authDomain: process.env.NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN, // Correct Name
  projectId: process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID, // Correct Name
  storageBucket: process.env.NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET, // Correct Name
  messagingSenderId: process.env.NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID, // Correct Name
  appId: process.env.NEXT_PUBLIC_FIREBASE_APP_ID, // Correct Name
