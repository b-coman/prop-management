...
const URL_PROPERTY_PAGES = ['/admin/pricing', '/admin/calendar', '/admin/website', '/admin/website/navigation', '/admin/website/settings', '/admin/housekeeping', '/admin/content-strategy'];
