...
//
// Replaces the `guestGuide` field and touches nothing else on the doc, so it will
// not disturb anything the admin UI has written to propertyOverrides. The field is
// replaced rather than merged so that keys removed here also disappear upstream.
  ...
  sections: [
    {
      ...
      body: {
        en: 'Wi-Fi - a high-speed fibre connection, with a Wi-Fi 6 router and a hotspot.\n\nParking - on the main street, right in front of the property.\n\nHeating - fully automated. For any request or malfunction, please contact us.\n\nTap water - drinkable, supplied by the city company. We still suggest bottled water for extra safety.\n\nFirewood - a small amount for lighting the BBQ is on us. Wood for a longer burn - the firepit and cauldron, the bonfire, or the indoor fireplace - is on request and normally carries a charge, unless it came included with your booking. Just ask us.\n\nSupplies - extra supplies on request. Fees may apply.\n\nBedsheets & towels - extra sets on request, for a small fee.\n\nCleaning - everything is carefully sanitised. A typical house prep takes about 6 hours; linens and towels are washed at 90°C, toilets and slippers disinfected.\n\nTerrace light - the switch is inside, to the right of the living room window.\n\nHigh chair - on the main bedroom balcony.\n\nExtra chairs - on the terrace.\n\nDishwasher tablets - in a basket behind the cabinet door under the sink.\n\nSwing cushions - in the storage box behind the swing. Please put them away overnight and when it rains.\n\nBalcony flowers - if you are staying a while, they would be glad of some water.\n\nZip line - about 30 m, safe up to 90 kg, used at your own risk.',
        ro: 'Wi-Fi - conexiune pe fibră, cu router Wi-Fi 6 și hotspot.\n\nParcare - pe strada principală, chiar în fața proprietății.\n\nÎncălzire - complet automatizată. Pentru orice solicitare sau defecțiune, vă rugăm să ne contactați.\n\nApa de la robinet - potabilă, furnizată de compania orașului. Vă recomandăm totuși apă îmbuteliată, pentru siguranță.\n\nLemne de foc - o cantitate mică pentru aprins grătarul este din partea noastră. Lemnele pentru un foc de durată - vatra cu ceaun, focul de tabără sau șemineul din casă - sunt la cerere și de obicei se percepe o taxă, dacă nu a fost deja inclusă în rezervare. Ne spuneți și ne ocupăm.\n\nConsumabile - la cerere. Se pot aplica taxe.\n\nLenjerie și prosoape - seturi suplimentare la cerere, contra unei mici taxe.\n\nCurățenie - totul este igienizat cu atenție. Pregătirea casei durează în jur de 6 ore; lenjeria și prosoapele se spală la 90°C, toaletele și papucii se dezinfectează.\n\nLumina de pe terasă - întrerupătorul este în casă, în dreapta ferestrei din living.\n\nScaun de masă pentru copii - pe balconul dormitorului principal.\n\nScaune în plus - pe terasă.\n\nTablete pentru mașina de vase - într-un coșuleț pe spatele ușii de dulap de sub chiuvetă.\n\nPernele balansoarului - în lada din spatele balansoarului. Vă rugăm să le puneți la loc peste noapte și când plouă.\n\nFlorile de pe balcon - dacă stați mai multe zile, s-ar bucura de puțină apă.\n\nTiroliana - circa 30 m, susține în siguranță până la 90 kg, se folosește pe propria răspundere.',
      },
    },
    {
      id: 'house-rules',
...
async function main() {
  ...
  await ref.update({ guestGuide: guide });
