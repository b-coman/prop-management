...
function AvailabilityCheck({ property, initialCheckIn, initialCheckOut }) {
    ...
    const [numberOfGuests, setNumberOfGuests] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$session$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSessionStorage"])(`booking_${property.id}_guests`, 1);
