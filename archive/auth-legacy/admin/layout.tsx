  ...
  return (
    <AdminAuthCheck>
      <div className="flex min-h-screen flex-col">
        ...
        {isDevelopment && authData.authenticated && (
          <div className="bg-green-500 text-green-950 text-xs text-center py-1">
            Development Mode - Authenticated as {authData.user?.email}
          </div>
        )}
